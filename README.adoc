...
NOTE: The cluster name is used as part of the S3 object key, therefore the https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-keys.html[S3 object key naming restrictions] also apply to the JGroups cluster name when using this protocol.
